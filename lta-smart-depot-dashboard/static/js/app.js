...
const DashboardApp = {
  ...
  currentLayout: "quad", // 'quad' | 'dual' | 'triple' | 'solo'
  activeSubsystems: {
    door: true,
    acv: true,
    rail: true,
    ...
    document.querySelectorAll(".filter-toggle-pill").forEach(pill => {
      ...
      if (checkbox) {
        ...
        pill.addEventListener("click", (e) => {
          ...
          pill.classList.toggle("checked", checkbox.checked);
          this.activeSubsystems[sub] = checkbox.checked;
          this.applyLayout();
  ...
  setLayoutPreset(preset) {
    ...
    if (preset === "quad") {
      this.activeSubsystems = { door: true, acv: true, rail: true, shm: true };
    } else if (preset === "dual") {
      this.activeSubsystems = { door: true, acv: true, rail: false, shm: false };
    } else if (preset === "triple") {
      this.activeSubsystems = { door: true, acv: true, rail: true, shm: false };
    } else if (preset === "solo") {
